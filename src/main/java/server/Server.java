...
public class Server implements Runnable {
    ...
    public static void main(String[] args) throws IOException {
        try (ServerSocket playersSocket = new ServerSocket(8080)) {
            ...
            for (int i = 0; i < 2; ) {
                ...
                if (player.getInetAddress().toString().equals(players[0]) || player.getInetAddress().toString().equals(players[1]) || player.getInetAddress().toString().equals(players[2])) {
                    ...
                    String ajaxFile = new String(Files.readAllBytes(Paths.get("src/main/resources/ajax.html")));
            ...
            try (ServerSocket controlsSocket = new ServerSocket(8080)) {
